...
VALUES ('user1', 'user1@email.com', crypt('user1password', gen_salt('bf')), 's', 'false', 'CU Boulder', ARRAY [1,6,4], NULL, 'Hello this is user1 I am very tired!', ARRAY ['CSCI']),
('user2', 'user2@email.com', crypt('user2password', gen_salt('bf')), 'n', 'false', 'CU Boulder', ARRAY [2,6], NULL, 'Hello this is user2 I am very tired!', ARRAY ['CSCI']),
('user3', 'user3@email.com', crypt('user3password', gen_salt('bf')), 's', 'false', 'CU Boulder', ARRAY [2,5], NULL, 'Hello this is user3 I am very tired!', ARRAY ['CSCI', 'ASTR']),
('user4', 'user4@email.com', crypt('user4password', gen_salt('bf')), 'n', 'false', 'CU Boulder', ARRAY [3], NULL, 'Hello this is user4 I am very tired!', ARRAY ['CSCI', 'ASTR']),
('admin', 'admin@email.com', crypt('admin1password', gen_salt('bf')), 'n', 'true', 'CU Boulder', ARRAY [3], NULL, 'Hello this is the admin I am very tired!', NULL);;
