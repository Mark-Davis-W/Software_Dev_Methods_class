...
Usage: This is to store the state to the tictactoe board.
When a move is made 
...
function begin_play(){
	console.log(document.getElementById("player1_id").innerHTML)
	// if(isEmpty(document.getElementById("player1_id")))
}
